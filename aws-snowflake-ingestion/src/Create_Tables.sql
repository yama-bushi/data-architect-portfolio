...
(
  ...
  ,attribute_ordinal varchar as (value:c7::varchar)
  ,source_database varchar as (value:c8::varchar)
  ,source_schema varchar as (value:c9::varchar)
  ,source_source_attribute varchar as (value:c10::varchar)
  ,source_data_type varchar as (value:c11::varchar)
)
...
CALL ENTERPRISEDATAHUB.FRAMEWORK.PROCESS_ENTITY_CREATION('ENTERPRISEDATAHUB','JFCNA_SMASH','LOYALTY_MASTER',0)